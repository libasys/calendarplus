...
var defaults = {
	...
	titleFormat: {
		...
		day: 'dddd, MMM d, yyyy',
		agendaThreeDays:"MMM d[ yyyy]{ '&#8212;'[ MMM] d yyyy}",
	},
	columnFormat: {
		year: 'MMMM',
		month: 'ddd',
...
fcViews.agendaThreeDays = AgendaThreeDaysView;

function AgendaThreeDaysView(element, calendar) {
	var t = this;
	...
	// imports
	AgendaView.call(t, element, calendar, 'agendaThreeDays');
	var opt = t.opt;
	var renderAgenda = t.renderAgenda;
	var skipHiddenDays = t.skipHiddenDays;
	var getCellsPerWeek = t.getCellsPerWeek;
...
function AgendaView(element, calendar, viewName) {
	...
	function buildSkeleton() {
		...
		slotScroller =
			$("<div id='scrollDiv' style='position:absolute;width:100%;overflow-x:hidden;overflow-y:auto'/>")
				.appendTo(slotLayer);
